...
var level_01_C = new Sprite();
	...
	level_01_C.create = function() {
		...
		level_01_C.button_fire.can_click = true;
		...
		level_01_C.button_fire.click = function() {
			if(level_01_C.button_fire.can_click) {
				level_01_C.stopAudio();
				...
				while(active_sprites.length > 0)
					active_sprites.pop();
				level_01_C.button_fire.can_click = false;
			}
		}
		...
		if(level_01_hub.targetC_cancall)
			world.addChild(level_01_C.button_call);
		world.addChild(level_01_C.button_fire);
		world.addChild(level_01_hub.timer_text);
		
		// Nice animation
		level_01_C.top_border = new Sprite();
		level_01_C.top_border.width  = 1080;
		level_01_C.top_border.height = 720;
		level_01_C.top_border.x = 0;
		level_01_C.top_border.y = 0;
		level_01_C.top_border.image = Textures.load("./Common/Textures/black box.png");
		level_01_C.top_border.update = function() {
			level_01_C.top_border.y -= 30;
			if(level_01_C.top_border.y < -720)
				world.removeChild(level_01_C.top_border);
		}
		
		level_01_C.bottom_border = new Sprite();
		level_01_C.bottom_border.width  = 1080;
		level_01_C.bottom_border.height = 720;
		level_01_C.bottom_border.x = 0;
		level_01_C.bottom_border.y = 0;
		level_01_C.bottom_border.image = Textures.load("./Common/Textures/black box.png");
		level_01_C.bottom_border.update = function() {
			level_01_C.bottom_border.y += 30;
			if(level_01_C.bottom_border.y > 720)
				world.removeChild(level_01_C.bottom_border);
		}
		
		world.addChild(level_01_C.top_border);
		world.addChild(level_01_C.bottom_border);
		sound_zoom.play();
	...
	level_01_C.endDialogue = function(ending) {
		while(nodes.length > 0)
			nodes.pop();
		level_01_hub.targetC_cancall = false;
	...
	level_01_C.pickEnding = function(ending) {
		switch(ending){
			case 1:
				...
				break;
			case 2: 
				level_01_hub.targetC_ending_info += "\nTarget C:He say’s he’s not waiting for a package…. \nand he seems to have listened to me. ";
				break;
			case 3:
			...
			case 5:
				...
				break;
			case 6:
				level_01_hub.targetC_ending_info += "\nTarget C:He has a lot on his plate? \nDoesn’t have to explain himself?";
				break;
			case 7:
